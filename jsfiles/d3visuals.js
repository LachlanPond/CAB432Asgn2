function drawBarGraph(array, words) {
	...
	var height = 500;
	document.getElementById("barchart").innerHTML = "<h1>Top 10 Mentioned Countries</h1>";
	...
	d3.tsv("data/countrydata.tsv", function(d) {
	  d.count = +d.count;
	  return d;
...
function drawPieChart() {
	...
	d3.tsv("data/piedata.tsv", function(d) {
	  d.count = +d.count;
	  return d;
	}, function(error, data) {
	  if (error) throw error;
